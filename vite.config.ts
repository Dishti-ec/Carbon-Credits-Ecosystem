...
:root {
  ...
  --input: transparent;
  --input-background: #f0f5ee;
  --switch-background: #b8c9b4;
  ...
  --radius: 0.625rem;
  --sidebar: #1b4332;
  --sidebar-foreground: #d8f3dc;
  --sidebar-primary: #52b788;
  --sidebar-primary-foreground: #ffffff;
  --sidebar-accent: #2d6a4f;
  --sidebar-accent-foreground: #d8f3dc;
  --sidebar-border: rgba(82, 183, 136, 0.2);
  --sidebar-ring: #52b788;
}
